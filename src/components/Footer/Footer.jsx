    ...
    <footer className='footer'>
      <Container>
        <Row>
          ...
          <div className='logo'>
                    <div >
                        <h1 className='text-white'> Goyal Traders </h1>
                    </div>
                </div>
          ...
          <div className="footer__quick-links">
              ...
              <ListGroup className='footer__contact'>
                ...
                <span><i class="ri-mail-line"></i></span>
                  <p>tradersxyz@gmail.com</p>
                </ListGroupItem>
               
              </ListGroup>
            </div>
          </Col>
          <Col lg='12'> <p className='footer__copyright'>
            Copyright {year} developed by Pranjal Deep. All rights reserved. </p>
          </Col>
        </Row>
      </Container>
    </footer>
